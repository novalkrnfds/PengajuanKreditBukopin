...
--
-- Host: 127.0.0.1
-- Generation Time: 19 Jul 2017 pada 20.13
...
CREATE TABLE `tb_nasabah` (
  ...
  `agama` enum('Islam','Khatolik','Protestan','Hindu','Budha','Lainnya') NOT NULL,
  `no_npwp` varchar(20) NOT NULL,
  `alamat` text NOT NULL,
  `lama_menetap` varchar(10) NOT NULL,
  `no_telprumah` varchar(10) NOT NULL,
  `no_hp` varchar(13) NOT NULL,
  `status_perkawinan` enum('Menikah','Belum Menikah','Janda/Duda') NOT NULL,
  `pendidikan` varchar(5) NOT NULL,
  `nama_ibukandung` varchar(40) NOT NULL,
  `jml_tanggungan` varchar(5) NOT NULL,
  `alamat_korespondensi` text NOT NULL,
  `kepemilikan_rumah` enum('Sendiri','Sewa/Kontrak','Orang tua','Dinas','Lainnya') NOT NULL,
...
INSERT INTO `user_login` (`id`, `name`, `email`, `password`, `level`) VALUES
(1, 'Nouval Kurnia Firdaus', 'admin@mail.com', 'e9e5038ade01c005d6d3e2ac2223bb4d', 1),
(2, 'Nasabah 1', 'nasabah1@mail.com', 'c7dcc69ffc075e8615d70e5be34bd29c', 3);
...
--
ALTER TABLE `tb_nasabah`
  MODIFY `id_nasabah` int(5) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_pekerjaan`
--
ALTER TABLE `tb_pekerjaan`
  MODIFY `id_pekerjaan` int(5) NOT NULL AUTO_INCREMENT;
--
